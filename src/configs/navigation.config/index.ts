...
const navigationConfig: NavigationTree[] = [
    ...
    },
    {
        ...
        subMenu: [
            ...
            {
                key: 'adminPayoutHistory',
                path: '/admin/payouts',
                title: 'Payout History',
                icon: 'transaction',
                translateKey: 'nav.payout.history',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [ADMIN],
                subMenu: [],
            },
        ...
        subMenu: [
            {
                ...
                translateKey: 'appSettingsManagement.collapse.item1',
                icon: 'list',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            },
            {
                ...
                title: 'App Setting Create',
                translateKey: 'appSettingsManagement.collapse.item2',
                icon: 'create',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
